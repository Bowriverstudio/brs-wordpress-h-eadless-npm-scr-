...
const { generateAcfTypescript, generateParseAcfCustomBlocks, createBlockScaffoldFiles } = require('brs-wordpress-headless-npm-scripts/utils/acf');
...
async function handleSelectedComponentSlug(selectedComponentSlug) {
    ...
    if (selectedComponent) {
        createBlockScaffoldFiles(selectedComponent.name)
    } else {
